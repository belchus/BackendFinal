...
async function newUser() {
  ...
  if(!age) {
    tostada ("Edad")
    document.querySelector('.age').classList.add('flasher')
  }
  if (!address) {
    tostada ("Direccion")
    document.querySelector('.address').classList.add('flasher')
  }
  if (!phone) {
    tostada ("Telefono")
    document.querySelector('.phone').classList.add('flasher')
  }
  if (!email) {
    tostada ("Email")
  ...
  if(firstname && lastname && age && address && phone && email && email2 && email == email2 && password && password2 && password == password2 && file) {
